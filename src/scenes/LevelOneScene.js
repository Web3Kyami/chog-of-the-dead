...
saveGameData();
    ...
    _applyUpgradesToPlayer() {
      ...
      let akClip = 35;
      if (akSet.includes("ak47_bullets_100")) akClip = 150;
      else if (akSet.includes("ak47_bullets_75")) akClip = 125;
      else if (akSet.includes("ak47_bullets_50")) akClip = 100;
      else if (akSet.includes("ak47_bullets_35")) akClip = 75;
      ...
      if (GameData.ownedWeapons.arrow) {
        if (arSet.includes("arrow_100")) arrowAmmo = 75;
        else if (arSet.includes("arrow_75")) arrowAmmo = 50;
        else if (arSet.includes("arrow_50")) arrowAmmo = 25;
        else if (arSet.includes("arrow_25")) arrowAmmo = 15;
        else arrowAmmo = 10;
      }
      let arLevel =
      ...
      this.player.arrowReloadMs = Math.max(550, 1000 - arLevel * 100);
      ...
      this.player.rocketReloadMs = Math.max(900, 1550 - rkLevel * 150);
